...
#define LEDC_OUTPUT_LEFT        (13) // Define the output GPIO
#define LEDC_OUTPUT_RIGHT       (4) // Define the output GPIO
...
#define DIR_OUTPUT_RIGHT        (16) // Motor driver direction pin
